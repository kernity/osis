...
urlpatterns = [
    ...
    url(r'^studies/assessments/scores_encoding/outside_period/$',
    ...
    url(r'^studies/assessments/scores_encoding/specific_criteria/search/$',
    ...
    url(r'^studies/assessments/scores_encoding/xlsdownload/([0-9]+)/$',
