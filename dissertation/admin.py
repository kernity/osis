...
admin.site.register(adviser.Adviser,
                    adviser.AdviserAdmin)
admin.site.register(dissertation.Dissertation,
                    dissertation.DissertationAdmin)
...
admin.site.register(proposition_offer.PropositionOffer,
                    proposition_offer.PropositionOfferAdmin)
admin.site.register(proposition_role.PropositionRole,
                    proposition_role.PropositionRoleAdmin)
